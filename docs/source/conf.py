...
# anomaly_detection_pipeline_kedro documentation build
...
from anomaly_detection_pipeline_kedro import __version__ as release
...
htmlhelp_basename = "anomaly_detection_pipeline_kedrodoc"
...
texinfo_documents = [
    (
        ...
        author,
        "anomaly_detection_pipeline_kedro",
        "Project anomaly_detection_pipeline_kedro codebase.",
        "Data-Science",
    )
]
